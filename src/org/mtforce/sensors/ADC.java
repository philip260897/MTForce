...
public class ADC extends Sensor {
	...
	public static final byte 240_SPS			= 0x00;	//Sample Rate Selection Bit, 240 SPS, 12 bits
	public static final byte 60_SPS 			= 0x04;	//Sample Rate Selection Bit, 60 SPS, 14 bits
	public static final byte 15_SPS 			= 0x08;	//Sample Rate Selection Bit, 15 SPS, 16 bits
	...
	public static final byte INIT_NEW_CONV 		= 0x80;	//One-Shot Conversion mode, Initiate a new conversion.
